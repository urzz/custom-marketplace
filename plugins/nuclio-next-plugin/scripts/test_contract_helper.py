...
HELPER = ROOT / "plugins" / "nuclio-next-plugin" / "scripts" / "contract-helper.py"
...
def contract_text(extra=""):
    ...
    tasks:
      - id: T1
        ...
        dependencies: []
        mutation_targets:
          - path: plugins/nuclio-next-plugin/scripts/a.py
            mode: create
        handoffs:
          inputs: []
          outputs:
...
class ContractHelperTests(unittest.TestCase):
    ...
    def test_valid_simple_contract_summary_identity_and_ownership(self):
        ...
        entry = ownership["paths"]["plugins/nuclio-next-plugin/scripts/a.py"]
...
context_policy:""",
    ...
    def test_rejects_duplicate_task_ids(self):
        ...
        dependencies: []
        mutation_targets:
          - path: plugins/nuclio-next-plugin/scripts/b.py
            mode: create
        handoffs:
          inputs: []
          outputs: []
