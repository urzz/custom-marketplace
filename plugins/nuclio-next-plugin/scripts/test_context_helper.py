...
HELPER = ROOT / "plugins" / "nuclio-next-plugin" / "scripts" / "context-helper.py"
VALID_HASH = "a" * 64
OTHER_HASH = "b" * 64
...
def stable_entry(**overrides):
    entry = {
        ...
        "audience": "contract",
        "mode": "stable",
        "path": "plugins/nuclio-next-plugin/references/contract.md",
...
def jit_entry(**overrides):
    entry = {
        ...
        "audience": "worker",
        "mode": "jit",
        "path": "plugins/nuclio-next-plugin/scripts/contract-helper.py",
